...
export const translations: Record<string, { de: string; en: string }> = {
  ...
  'merge.customSheetNamesCollapsed': { de: 'Optional: Namen der Sheets in der Merge-Datei festlegen oder mit Schnellnamen belegen.', en: 'Optional: set sheet names in the merged file or apply quick-name patterns.' },
  'merge.customSheetNamesIntro': { de: 'Die Namen unten sind genau die Sheets in der fertigen Excel/ODS-Datei. Direkt bearbeiten oder per Schnellnamen (z. B. 01, 02, 03) setzen; „Zurücksetzen“ stellt die Standardnamen wieder her (Dateiname bzw. „Dateiname – Sheetname“).', en: 'The names below are the exact sheets in the final Excel/ODS file. Edit them directly or use quick names (e.g. 01, 02, 03); "Reset" restores the default names (filename or "filename – sheet name").' },
  'merge.customSheetNamesNoFiles': { de: 'Zuerst Dateien hinzufügen – dann erscheinen hier die Einträge für die Sheet-Namen.', en: 'Add files first – then the entries for sheet names will appear here.' },
