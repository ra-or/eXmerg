...
export const translations: Record<string, { de: string; en: string }> = {
  ...
  'upload.limits': {
    de: 'max. {n} Dateien · {mb} MB pro Datei · {totalMb} MB gesamt',
    en: 'max. {n} files · {mb} MB per file · {totalMb} MB total',
  },
  ...
  'merge.hintNoFiles': {
    de: 'Modus und Ausgabeformat festlegen – sie gelten nach dem Hochladen.',
    en: 'Set mode and output format – they apply after upload.',
  },
  ...
  'merge.customSheetNames': { de: 'Namen der Sheets in der Ausgabedatei', en: 'Sheet names in output file' },
  'merge.customSheetNamesCollapsed': {
    de: 'Optional: Namen der Sheets in der Merge-Datei festlegen oder mit Schnellnamen belegen.',
    en: 'Optional: set sheet names in the merged file or apply quick-name patterns.',
  },
  'merge.customSheetNamesIntro': {
    de: 'Die Namen unten sind genau die Sheets in der fertigen Excel/ODS-Datei. Direkt bearbeiten oder per Schnellnamen (z. B. 01, 02, 03) setzen; „Zurücksetzen“ stellt die Standardnamen wieder her (Dateiname bzw. „Dateiname – Sheetname“).',
    en: 'The names below are the exact sheets in the final Excel/ODS file. Edit them directly or use quick names (e.g. 01, 02, 03); "Reset" restores the default names (filename or "filename – sheet name").',
  },
  'merge.customSheetNamesNoFiles': {
    de: 'Zuerst Dateien hinzufügen – dann erscheinen hier die Einträge für die Sheet-Namen.',
    en: 'Add files first – then the entries for sheet names will appear here.',
  },
  'merge.customSheetNamesColSource': { de: 'Quelle (Datei / Sheet)', en: 'Source (file / sheet)' },
  'merge.customSheetNamesColOutput': { de: 'Name des Sheets in der Ausgabedatei', en: 'Sheet name in output file' },
  'merge.customSheetNamesSingle': { de: 'Eine Datei mit einem Sheet', en: 'One file, one sheet' },
  'merge.customSheetNamesMulti': { de: 'Datei mit mehreren Sheets', en: 'File with multiple sheets' },
  'merge.customSheetNamesPlaceholder': { de: 'Name bearbeiten', en: 'Edit name' },
  'merge.namePatternsLabel': { de: 'Schnellnamen:', en: 'Quick names:' },
  'merge.namePattern01': { de: '01, 02, 03', en: '01, 02, 03' },
  'merge.namePattern001': { de: '001, 002, 003', en: '001, 002, 003' },
  'merge.namePattern1': { de: '1, 2, 3', en: '1, 2, 3' },
  'merge.namePatternSheet': { de: 'Sheet 1, 2, …', en: 'Sheet 1, 2, …' },
  'merge.namePatternTab': { de: 'Tab 01, 02, …', en: 'Tab 01, 02, …' },
  'merge.namePatternData': { de: 'Data 01, 02, …', en: 'Data 01, 02, …' },
  'merge.namePatternReset': { de: 'Zurücksetzen', en: 'Reset' },
  ...
  'mode.one_file_per_sheet.desc': {
    de: 'Jede Datei bekommt ein eigenes Sheet. Farben, Rahmen, verbundene Zellen, Spaltenbreiten und Formeln bleiben vollständig erhalten. Unterstützt XLSX und ODS.',
    en: 'Each file gets its own sheet. Colours, borders, merged cells, column widths and formulas are fully preserved. Supports XLSX and ODS.',
  },
  'mode.consolidated_sheets.desc': {
    de: 'Sheet 1 = Zusammenfassung: numerische Werte werden zelladressgenau summiert, Formeln bleiben mit aktualisierten Ergebnissen erhalten. Danach folgt jede Datei als eigenes formatiertes Sheet. Unterstützt XLSX und ODS.',
    en: 'Sheet 1 = Summary: numeric values are summed by cell address, formulas are kept with updated results. Then each file as its own formatted sheet. Supports XLSX and ODS.',
  },
  'mode.all_to_one_sheet.desc': {
    de: 'Alle Dateien werden untereinander in ein einziges Sheet gestapelt – inklusive Farben, Rahmen, verbundene Zellen, Spaltenbreiten und Formeln. Unterstützt XLSX und ODS.',
    en: 'All files are stacked into a single sheet – including colours, borders, merged cells, column widths and formulas. Supports XLSX and ODS.',
  },
  'mode.all_with_source_column.desc': {
    de: 'Wie „Alles in eine Tabelle", jedoch mit einer zusätzlichen Spalte ganz links, die für jede Datei den Dateinamen anzeigt. Vollständige Formatierung bleibt erhalten. Unterstützt XLSX und ODS.',
    en: 'Like "All in one table", but with an extra left column showing the filename for each file. Full formatting is preserved. Supports XLSX and ODS.',
  },
  'mode.row_per_file.desc': {
    de: 'Wie Zeilenmatrix, plus eine Gesamt-Zeile unten mit den Spaltensummen. Ideal für tägliche Berichte.',
    en: 'Like row matrix, plus a total row at the bottom with column sums. Ideal for daily reports.',
  },
  'mode.row_per_file_no_sum.desc': {
    de: 'Jede Datei wird zu einer Zeile, Spaltenheader aus Zellreferenzen (A1, B1, …). Nur die Dateien, keine Summenzeile.',
    en: 'Each file becomes one row, column headers from cell refs (A1, B1, …). File rows only, no total row.',
  },
  ...
  'action.mergeSuccessMessage': {
    de: 'Merge abgeschlossen – {filename} ist bereit zum Herunterladen.',
    en: 'Merge complete – {filename} is ready to download.',
  },
  'action.mergeSuccessDownloading': {
    de: 'Merge abgeschlossen – {filename} wird heruntergeladen.',
    en: 'Merge complete – {filename} is being downloaded.',
  },
  ...
  'action.longRunning': {
    de: 'Merge läuft noch (über 2 Minuten) – bitte Geduld.',
    en: 'Merge still running (over 2 min) – please wait.',
  },
  ...
  'error.hintOom': {
    de: 'Tipp: Weniger Dateien oder kleinere Dateien wählen.',
    en: 'Tip: Use fewer or smaller files.',
  },
  'error.hintTimeout': {
    de: 'Tipp: Weniger Dateien auf einmal mergen oder kleinere Dateien verwenden.',
    en: 'Tip: Merge fewer files at once or use smaller files.',
  },

  // Upload (Drag & Drop Rückmeldung)
  'upload.skippedInvalid': {
    de: '{n} Datei(en) nicht hinzugefügt: falsches Format, über {mb} MB pro Datei oder über {totalMb} MB gesamt.',
    en: '{n} file(s) not added: wrong format, over {mb} MB per file, or over {totalMb} MB total.',
  },
  ...
  'history.privacy': {
    de: 'Einträge werden nur lokal in diesem Browser gespeichert – niemand sonst hat Zugriff (Datenschutz).',
    en: 'Entries are stored only locally in this browser – no one else has access (privacy).',
  },
  'history.addAsSource': { de: '+Quelle', en: '+Source' },
  'history.addSourceTitle': {
    de: 'Als Eingabe-Datei zur Merge-Liste hinzufügen',
    en: 'Add as input file to merge list',
  },
  ...
  // File list
  'files.unitFile': { de: 'Datei', en: 'file' },
  'files.unitFiles': { de: 'Dateien', en: 'files' },
  'files.unitSheet': { de: 'Sheet', en: 'sheet' },
  'files.unitSheets': { de: 'Sheets', en: 'sheets' },
  'files.totalAvailable': {
    de: '{fileCount} {fileLabel} und {sheetCount} {sheetLabel} vorhanden',
    en: '{fileCount} {fileLabel} and {sheetCount} {sheetLabel} in list',
  },
  'files.summaryShort': {
    de: '{fileCount} Dateien · {sheetCount} Sheets',
    en: '{fileCount} files · {sheetCount} sheets',
  },
  'files.selectedCountBadge': { de: '{n} ausgewählt', en: '{n} selected' },
  'files.selectedForMerge': {
    de: '{fileCount} {fileLabel} · {sheetCount} {sheetLabel} ausgewählt',
    en: '{fileCount} {fileLabel} · {sheetCount} {sheetLabel} selected',
  },
  ...
  'files.sort.dragHint': {
    de: 'Zum Umsortieren „Upload-Reihenfolge“ wählen',
    en: 'Choose „Upload order“ to drag & drop',
  },
  ...
  'files.previewSheetRows': { de: 'Vorschau „{name}" (erste {n} Zeilen):', en: 'Preview "{name}" (first {n} rows):' },
  'files.sheets': { de: 'Sheets', en: 'Sheets' },
  'files.sheetsSelect': {
    de: 'Sheets auswählen – leer = alle sheets mergen:',
    en: 'Select sheets – empty = merge all:',
  },
  ...
  'duplicates.alreadyPresent': {
    de: 'Dateien bereits vorhanden – übersprungen',
    en: 'Files already present – skipped',
  },
  ...
  'duplicates.skippedMany': {
    de: 'Dateien wurden als Duplikat übersprungen.',
    en: 'files were skipped as duplicates.',
  },
  'duplicates.skippedWithNames': {
    de: '{n} Datei(en) als Duplikat übersprungen: {names}',
    en: '{n} file(s) skipped as duplicate(s): {names}',
  },

  // Duplicates & warnings
  'duplicates.warning': { de: '{n} doppelte Datei(en) übersprungen.', en: '{n} duplicate file(s) skipped.' },
  'warnings.filesFailed': {
    de: '{n} Datei(en) konnte(n) nicht verarbeitet werden:',
    en: '{n} file(s) could not be processed:',
  },
  ...
  'templates.saveTitle': {
    de: 'Aktuelle Einstellungen als Vorlage speichern',
