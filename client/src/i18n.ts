...
export const translations: Record<string, { de: string; en: string }> = {
  ...
  'merge.customSheetNames':      { de: 'Namen der Tab-Reiter in der Ausgabedatei', en: 'Tab names in output file' },
  'merge.customSheetNamesCollapsed': { de: 'Optional: Namen der Reiter in der Merge-Datei festlegen oder mit Schnellnamen belegen.', en: 'Optional: set tab names in the merged file or apply quick-name patterns.' },
  'merge.customSheetNamesIntro': { de: 'Die Namen unten sind genau die Tab-Reiter in der fertigen Excel/ODS-Datei. Direkt bearbeiten oder per Schnellnamen (z. B. 01, 02, 03) setzen; „Zurücksetzen“ stellt die Standardnamen wieder her (Dateiname bzw. „Dateiname – Sheetname“).', en: 'The names below are the exact tab labels in the final Excel/ODS file. Edit them directly or use quick names (e.g. 01, 02, 03); "Reset" restores the default names (filename or "filename – sheet name").' },
  'merge.customSheetNamesNoFiles': { de: 'Zuerst Dateien hinzufügen – dann erscheinen hier die Einträge für die Tab-Namen.', en: 'Add files first – then the entries for tab names will appear here.' },
  'merge.customSheetNamesColSource': { de: 'Quelle (Datei / Sheet)', en: 'Source (file / sheet)' },
  'merge.customSheetNamesColOutput': { de: 'Name des Reiters in der Ausgabedatei', en: 'Tab name in output file' },
  ...
  'files.totalAvailable':    { de: '{fileCount} {fileLabel} und {sheetCount} {sheetLabel} vorhanden', en: '{fileCount} {fileLabel} and {sheetCount} {sheetLabel} in list' },
  ...
  'files.selectedForMerge':   { de: '{fileCount} {fileLabel} · {sheetCount} {sheetLabel} ausgewählt', en: '{fileCount} {fileLabel} · {sheetCount} {sheetLabel} selected' },
