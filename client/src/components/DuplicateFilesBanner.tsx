...
export function DuplicateFilesBanner() {
  ...
  return (
    ...
    >
      {/* Buttons fix oben, nur die Dateiliste scrollt */}
      <div className="flex flex-wrap items-center gap-2 shrink-0">
        <button
          type="button"
          onClick={() => replaceSelectedDuplicates()}
      ...
      <ul className="list-none pl-0 space-y-1 border-t border-amber-500/20 pt-1.5 mt-1.5 max-h-48 overflow-y-auto pr-1">
